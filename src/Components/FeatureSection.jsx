  ...
  return (
    <div className='relative mt-20 border-b border-neutral-800 min-h-[800px]'>
        <div className='text-center'>
            <span className='bg-neutral-800 text-pink-700 rounded-full h-6 text-sm font-medium px-2 py-1 uppercase'>
                features
            </span>
        ...
        <div className='flex flex-wrap mt-10 lg:mt-20 ml-10 mr-10'>
            {features.map((feature,index) => (
                <div key={index} className='w-full sm:1/2 lg:w-1/3'>
                    ...
                    <h5 className='mt-1 mb-6 text-xl ml-2'>{feature.text}</h5>
